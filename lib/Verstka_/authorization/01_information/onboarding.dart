...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> _texts = [
    'Бикард" клиникасына кош келиңиз ',
    'Адистер менен байланышыңыз',
    'Миңдеген диагностикалык кызматтары',
  ];
  List<String> _texts_2 = [
    'Ден-соолугуңузга жана жыргалчылыгыңызга кам көрүү биздин башкы приоритетибиз болгон клиникабызга сизди тосуп алганыбызга кубанычтабыз.',
    '"Бикардда" биз заманбап технологияларды ар бир пациентке жекече мамиле кылуу менен айкалыштырып, жогорку сапаттагы медициналык кызмат көрсөтүүгө умтулабыз.',
    '"Бикард" клиникасы - бул диагностикалык жана дарылоо кызматтарынын кеңири спектрин сунуш кылган көп тармактуу медициналык мекеме',
  ];
